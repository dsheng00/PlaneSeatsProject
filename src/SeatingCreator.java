		...
		while (!response.equalsIgnoreCase(SENTINEL))
		{
			...
			if (choice.equals("1"))
			{
				...
				else if (reChoice.substring(0, 4).equalsIgnoreCase("auto"))
				{
					...
					{
						System.out.print("Enter the number of seats you would like "
								+ "reserved together (up to 2). ");
					}
					else
					{
						System.out.print("Enter the number of seats you would like "
								+ "reserved together (up to 3). ");
					}
...
>>>>>>> origin/master
					...
					else if (pref.equalsIgnoreCase("middle"))
					{
						...
						{
							if ((foundSeat == false) 
									&& !plane.checkOccupied(flightClass, i, 2))
							{
								foundSeat = true;
...
>>>>>>> origin/master
					...
					else if (pref.equalsIgnoreCase("aisle"))
					{
						...
						{
							if ((foundSeat == false) 
									&& !plane.checkOccupied(flightClass, i, 3))
							{
								foundSeat = true;
